--Display a list of product colours
SELECT ISNULL(Color, 'None') AS Color FROM SalesLT.Product;

--Display a list of product colours without duplicates
SELECT DISTINCT ISNULL(Color, 'None') AS Color FROM SalesLT.Product;

--Display a list of product colours without duplicates ordered by color
